...
func schemaV1Json() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/v1.json", size: 761, mode: os.FileMode(420), modTime: time.Unix(1501238439, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func schemaVmEsxiJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/vm/esxi.json", size: 1342, mode: os.FileMode(420), modTime: time.Unix(1501238439, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
