...
func schemaVmLxcJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/vm/lxc.json", size: 3456, mode: os.FileMode(420), modTime: time.Unix(1493443345, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func schemaVmNullJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/vm/null.json", size: 800, mode: os.FileMode(420), modTime: time.Unix(1493458346, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
