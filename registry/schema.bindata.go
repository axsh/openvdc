...
func schemaV1Json() (*asset, error) {
	...
	info := bindataFileInfo{name: "schema/v1.json", size: 2525, mode: os.FileMode(420), modTime: time.Unix(1480911486, 0)}
