...
func SchemaV1Json() (*asset, error) {
	...
	info := bindataFileInfo{name: "../schema/v1.json", size: 5519, mode: os.FileMode(420), modTime: time.Unix(1489131235, 0)}
