...
func (d *LXCHypervisorDriver) MetadataDrivePath() string {
	return filepath.Join(d.containerDir(), "/rootfs/etc/openvdc/metadata/meta-data/")
}
...
func (d *LXCHypervisorDriver) CreateInstance() error {
	...
	if err := os.MkdirAll(filepath.Join(d.containerDir(), "rootfs/etc/openvdc/metadata/meta-data/"), os.ModePerm); err != nil {
