...
const (
	InstanceEventReply_None  InstanceEventReply_EventType = 0
	InstanceEventReply_State InstanceEventReply_EventType = 1
)
...
type InstanceEventReply struct {
	EventType InstanceEventReply_EventType `protobuf:"varint,1,opt,name=event_type,json=eventType,enum=api.InstanceEventReply_EventType" json:"event_type,omitempty"`
	EventAt   *google_protobuf.Timestamp   `protobuf:"bytes,2,opt,name=event_at,json=eventAt" json:"event_at,omitempty"`
...
func (m *InstanceEventReply) GetEventType() InstanceEventReply_EventType {
	...
	return InstanceEventReply_None
}
...
func (*ResourceRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{23} }
...
func (*ResourceReply) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{24} }
...
func (*ResourceIDRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{25} }
...
var fileDescriptor0 = []byte{
	...
	,
}
