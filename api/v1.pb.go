...
type InstanceClient interface {
	...
	Log(ctx context.Context, in *InstanceLogRequest, opts ...grpc.CallOption) (*InstanceLogReply, error)
}
...
func (c *instanceClient) Log(ctx context.Context, in *InstanceLogRequest, opts ...grpc.CallOption) (*InstanceLogReply, error) {
	out := new(InstanceLogReply)
	err := grpc.Invoke(ctx, "/api.Instance/Log", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InstanceServer interface {
	...
	Log(context.Context, *InstanceLogRequest) (*InstanceLogReply, error)
}
...
func _Instance_Log_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InstanceLogRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InstanceServer).Log(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.Instance/Log",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InstanceServer).Log(ctx, req.(*InstanceLogRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var fileDescriptor0 = []byte{
	...
	,
}
