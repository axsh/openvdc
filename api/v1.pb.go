...
type ConsoleReply struct {
	InstanceId string             `protobuf:"bytes,1,opt,name=instance_id,json=instanceId" json:"instance_id,omitempty"`
	Type       model.Console_Type `protobuf:"varint,2,opt,name=type,enum=model.Console_Type" json:"type,omitempty"`
...
func (m *ConsoleReply) GetType() model.Console_Type {
	if m != nil {
		return m.Type
	}
	return model.Console_SSH
}
...
var fileDescriptor0 = []byte{
	...
	,
}
