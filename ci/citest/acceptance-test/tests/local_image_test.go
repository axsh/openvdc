...
func TestLocalImage(t *testing.T) {
	...
	stdout, _ := RunCmdAndReportFail(t, "openvdc", "run", "./openvdc run https://raw.githubusercontent.com/axsh/openvdc/template-misc/templates/centos/7/lxc2.json", `{"node_groups":["linuxbr"]}`)
