...
const (
	...
	AuthenticationType_PUB_KEY AuthenticationType = 1
)
...
type LxcTemplate struct {
	...
	AuthenticationType AuthenticationType       `protobuf:"varint,9,opt,name=authentication_type,enum=model.AuthenticationType" json:"authentication_type,omitempty"`
...
func (m *LxcTemplate) GetAuthenticationType() AuthenticationType {
	if m != nil {
...
func (m *QemuTemplate) GetAuthenticationType() AuthenticationType {
	if m != nil {
		return m.AuthenticationType
	}
	return AuthenticationType_NONE
...
func (m *QemuTemplate) GetSshPublicKey() string {
	if m != nil {
		return m.SshPublicKey
	}
	return ""
...
type NullTemplate struct {
	...
	AuthenticationType AuthenticationType      `protobuf:"varint,5,opt,name=authentication_type,enum=model.AuthenticationType" json:"authentication_type,omitempty"`
	SshPublicKey       string                  `protobuf:"bytes,6,opt,name=ssh_public_key" json:"ssh_public_key,omitempty"`
}
...
func (m *NullTemplate) GetAuthenticationType() AuthenticationType {
	if m != nil {
		return m.AuthenticationType
	}
	return AuthenticationType_NONE
...
func (m *NullTemplate) GetSshPublicKey() string {
	if m != nil {
		return m.SshPublicKey
	}
	return ""
...
func init() {
	...
	proto.RegisterEnum("model.AuthenticationType", AuthenticationType_name, AuthenticationType_value)
...
var fileDescriptor0 = []byte{
	...
	,
}
